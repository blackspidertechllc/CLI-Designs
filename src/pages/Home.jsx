...
export default function Home() {
  ...
  const residentialPrimaryImage =
    featuredResidential?.bottomImage || featuredResidential?.topLeftImage || HeroImage;
  ...
  return (
    <main className="bg-[#111111] text-[#f5f1ea]">
      {/* Hero */}
      <section className="relative min-h-screen overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-black/10 via-black/30 to-[#111111]" />
        </div>
        ...
        <div className="relative mx-auto flex min-h-screen max-w-7xl items-end px-4 pb-16 pt-32 sm:px-6 md:pb-20 lg:px-12 lg:pb-24">
          <div className="max-w-4xl">
            <p className="font-brand text-xs font-semibold uppercase tracking-[0.28em] text-[#d8cfc3]/80 sm:text-sm">
              CLI Designs
            </p>

            <h1 className="mt-5 max-w-5xl font-brand text-4xl font-semibold leading-[0.98] text-[#f7f2eb] sm:text-5xl lg:text-7xl">
            ...
            <div className="mt-8">
              <NavLink
                to="/projects"
                className="inline-flex items-center rounded-full border border-[#d2c2aa]/35 bg-white/10 px-6 py-3 font-brand text-sm font-semibold text-[#f7f2eb] backdrop-blur-sm transition duration-300 hover:bg-[#f7f2eb] hover:text-[#111111]"
              >
                View Projects
              </NavLink>
            </div>
      ...
      {/* Brand Statement */}
      <section className="border-t border-white/10 bg-[#151515] py-16 lg:py-24">
        <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 md:grid-cols-[0.7fr_1.3fr] md:gap-16 lg:px-12">
          <div>
            <p className="font-brand text-xs font-semibold uppercase tracking-[0.28em] text-[#c9b79b]/70 sm:text-sm">
              Our Perspective
            </p>
          </div>

          <div className="max-w-4xl">
            <p className="font-brand text-2xl leading-[1.35] text-[#f1e8dc] sm:text-3xl lg:text-4xl">
          ...
          <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-end lg:gap-14">
            <div className="overflow-hidden rounded-[2rem] border border-white/10 bg-white/5">
              <img
                ...
                alt={featuredResidential?.bottomAlt || featuredResidential?.title || "Featured residential project"}
            ...
            <div className="lg:pb-8">
              ...
              <h2 className="mt-4 font-brand text-3xl font-semibold leading-[1.05] text-[#f7f2eb] sm:text-4xl lg:text-5xl">
                {featuredResidential?.title || "Selected Residential Work"}
              </h2>

              <p className="mt-6 max-w-xl font-brand text-base leading-7 text-[#d9d0c5] sm:text-lg">
              ...
              <div className="mt-8">
                <NavLink
                  to="/projects"
                  className="inline-flex items-center rounded-full border border-[#d2c2aa]/30 px-6 py-3 font-brand text-sm font-semibold text-[#f7f2eb] transition duration-300 hover:bg-[#f7f2eb] hover:text-[#111111]"
                >
          ...
          <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr] lg:gap-10">
            ...
            <div className="flex flex-col justify-between gap-6">
              <div className="rounded-[2rem] border border-white/10 bg-white/5 p-8 sm:p-10 lg:p-12">
                ...
                <h2 className="mt-4 max-w-2xl font-brand text-3xl font-semibold leading-[1.08] text-[#f7f2eb] sm:text-4xl lg:text-5xl">
                  Design shaped by feeling, function, and quiet confidence.
                </h2>

                <p className="mt-6 max-w-2xl font-brand text-base leading-7 text-[#d9d0c5] sm:text-lg">
                ...
                <NavLink
                  to="/about"
                  className="mt-8 inline-flex items-center rounded-full border border-[#d2c2aa]/30 px-6 py-3 font-brand text-sm font-semibold text-[#f7f2eb] transition duration-300 hover:bg-[#f7f2eb] hover:text-[#111111]"
                >
                  Learn More
                </NavLink>
              </div>
              ...
              <div className="overflow-hidden rounded-[2rem] border border-white/10 bg-white/5">
                <img
                  ...
                  alt={featuredCommercial?.images?.[0]?.alt || featuredCommercial?.title || "Featured commercial project"}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-12">
          <div className="flex flex-col gap-10 lg:gap-14">
            <div className="max-w-3xl">
              ...
              <h2 className="mt-4 font-brand text-3xl font-semibold leading-[1.08] text-[#f7f2eb] sm:text-4xl lg:text-5xl">
            ...
            <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
              <article className="overflow-hidden rounded-[2rem] border border-white/10 bg-white/5">
                <img
                  ...
                  alt={featuredResidential?.topLeftAlt || featuredResidential?.title || "Residential interior project"}
                  className="h-[340px] w-full object-cover sm:h-[420px] lg:h-[520px]"
                />

                <div className="p-6 sm:p-8">
                  <h3 className="font-brand text-2xl font-semibold text-[#f7f2eb] sm:text-3xl">
                    {featuredResidential?.title || "Residential Design"}
                  </h3>

                  <p className="mt-4 max-w-xl font-brand text-base leading-7 text-[#d9d0c5]">
                    {featuredResidential?.description ||
              ...
              <article className="overflow-hidden rounded-[2rem] border border-white/10 bg-white/5 lg:translate-y-12">
                <img
                  src={commercialSecondaryImage}
                  alt={featuredCommercial?.images?.[1]?.alt || featuredCommercial?.title || "Commercial interior project"}
                  className="h-[340px] w-full object-cover sm:h-[420px] lg:h-[460px]"
                />

                <div className="p-6 sm:p-8">
                  <p className="font-brand text-xs font-semibold uppercase tracking-[0.24em] text-[#c9b79b]/70">
                    Commercial
                  </p>

                  <h3 className="mt-3 font-brand text-2xl font-semibold text-[#f7f2eb] sm:text-3xl">
                    {featuredCommercial?.title || "Commercial Design"}
                  </h3>

                  <p className="mt-4 font-brand text-base leading-7 text-[#d9d0c5]">
      ...
      {/* Capabilities */}
      <section className="border-y border-white/10 bg-[#151515] py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-12">
      ...
      <section className="bg-[#111111] py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-12">
          <div className="rounded-[2rem] border border-white/10 bg-white/5 p-8 sm:p-10 lg:p-14">
            <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end">
              ...
              <div>
                <NavLink
                  to="/contact"
                  className="inline-flex items-center rounded-full bg-[#f7f2eb] px-6 py-3 font-brand text-sm font-semibold text-[#111111] transition duration-300 hover:bg-[#d8c7ae]"
                >
                  Contact Us
                </NavLink>
              </div>
