    ...
    <section className="relative overflow-hidden bg-parchment py-20 lg:py-28">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-12">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-[1.1fr_0.9fr] md:items-start md:gap-12 lg:gap-16">
          {/* Title */}
          <div className="order-1 md:order-1 md:row-start-1">
          ...
          {/* Image */}
          <div className="order-2 aspect-[4/5] overflow-hidden rounded-3xl border border-tan/20 bg-almond-cream shadow-md transition-shadow hover:shadow-lg md:order-2 md:col-start-2 md:row-span-2 md:row-start-1">
            <img
              src={CassieHeadshot}
          ...
          {/* Bio */}
          <div className="order-3 rounded-3xl border border-tan/20 bg-almond-cream p-8 shadow-md transition-shadow hover:shadow-lg sm:p-10 md:order-3 md:col-start-1 md:row-start-2">
            <p className="font-brand text-base leading-7 text-dusty-taupe/65 sm:text-lg">
              ...
              point of view. With a solid technical background, Cassiana is
              proficient in tools such as AutoCAD and SketchUp for detailed
              architectural drawings and spatial planning, alongside digital
              presentation and documentation tools that support clear, cohesive
              design development from concept through execution. Her ability to
              translate ideas into precise plans ensures that each design is not
              only visually compelling, but thoughtfully resolved. With a
              natural instinct for elevating spaces and a trained eye for
              ...
              intuitive in how they flow and are experienced. Constantly
              evolving, she draws inspiration from both emerging trends and
              timeless design principles — reinterpreting them in ways that feel
              fresh, relevant, and enduring. Her process is collaborative and
              considered, rooted in clear communication and a genuine
              understanding of each client's lifestyle. Each project is
              approached with intention and care — resulting in spaces that not
              only look exceptional, but feel effortless to live in.
            </p>
          </div>
        </div>
      </div>
